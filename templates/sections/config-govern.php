<section id="gobteam" class="wrap wrap--content wrap--form wrap--shadow wrap--hidden js-section active">
    ...
    <form method="POST" action="">
        ...
        <!-- submit -->
        <?php wpdc_the_submit('updatesection', 'changegovern', '', '', 'Cambiar gobierno');?>
    </form>
