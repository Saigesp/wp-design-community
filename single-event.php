...
<div class="flexboxer flexboxer--event">
	...
	<?php if($EM_Event->location_id > 0){?>
		<section class="wrap wrap--frame wrap--flexboxer">
			<div class="wrap wrap--flexed wrap--flexed__middle">
				<h3>Localización</h3>
				<p><?php echo $EM_Event->output('#_LOCATIONNAME');?><br>
				<?php echo $EM_Event->output('#_LOCATIONADDRESS').', '.$EM_Event->output('#_LOCATIONTOWN');?></p>
			</div>
			<div class="wrap wrap--flexed wrap--flexed__middle wrap--flexed__frame">
...
<!-- booking -->
<?php // if(strtotime('now') < $event_end_date && $EM_Event->event_rsvp == 1){ // If evento actual  ?>
