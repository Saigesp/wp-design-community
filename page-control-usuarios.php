...
<style>
  #usercontroloption, #usercontrolfilter {font-size: 0.7rem; margin: 10px;}
  #usercontroloption .button, #usercontrolfilter .button {margin: 0; font-size: 0.7rem;} 
  
  #usercontrolmain {margin: 10px;}
  #usercontrolmain table {width: 100%; text-align: left; font-size: 0.7rem; line-height: 0.7rem;}
