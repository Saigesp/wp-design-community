<ul class="rrssb-buttons actrrss-buttons clearfix">
    <li class="rrssb-email">
        <a target="popup" onclick="window.open('mailto:?subject=Mira%20este%20art%C3%ADculo%20de%20dise%C3%B1adoresindustriales.es&amp;body=Creo%20que%20esto%20puede%20interesarte:%20<?php the_permalink();?>','name','width=600,height=400')">
    ...
    <li class="rrssb-twitter">
        <a target="popup" class="popup" onclick="window.open('http://twitter.com/home?status=<?php the_title();?>%20<?php the_permalink();?>%20via%20@DisIndEs','name','width=600,height=400')">
            <span class="rrssb-icon">
